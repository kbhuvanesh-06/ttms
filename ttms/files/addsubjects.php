                ...
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subjectdepartment" name="SD">
                            <option selected disabled>Select</option>
                            <option value="Computer Engg.">BBA CA.</option>
                            <option value="Electronics Engg.">BCA.</option>
                            <option value="Electrical Engg.">BBA.</option>
                            <option value="Mechanical Engg.">BA.</option>
                        </select>
                    </div>
