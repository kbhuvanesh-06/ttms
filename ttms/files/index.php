...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, BBA CA  DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/compdept.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/building.jpg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> BBACA I Year ( Semester I )</option>
            <option value="4"> BBACA I Year ( Semester II )</option>
            <option value="5"> BBACA II Year ( Semester III )</option>
            <option value="6"> BBACA II Year ( Semester IV )</option>
            <option value="7"> BBACA III Year ( Semester V )</option>
            <option value="8"> BBACA III Year( Semester VI )</option>
        </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">DR. ALIFIYA</h3>
                    <hr/>
                    <h4 align="center">HOD <br/>BBACA </h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">DR. BOOTWALA</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> AISC</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/pa.jpg" class="img-rounded"/>
                    <h3 align="center">DR. INAMDAR</h3>
                    <hr/>
                    <h4 align="center">Chairman<br/>AZAM CAMPUS</h4>
